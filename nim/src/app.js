...
function aux_write_stack_trace_21151(f_21153) {
	...
	var result_21154 = [null];
		...
		L6: do {
			var j_21421 = 0;
			var colontmp__223390 = 0;
			colontmp__223390 = (i_21164 - 1);
			var res_223395 = colontmp__223390;
			L7: do {
					L8: while (true) {
					if (!(0 <= res_223395)) break L8;
						j_21421 = res_223395;
...
function use_state_220045(val_220047) {

		function innerHEX60gensym220066_220067() {
			var result_220069 = null;

			var F={procname:"useState.inner`gensym220066",prev:framePtr,filename:"jsffi.nim",line:0};
			framePtr = F;
			BeforeRet: do {
				F.line = 430;
				var a_220070 = null;
				...
				a_220070 = {};
				F.line = 441;
				a_220070.val = obj_220049[chckIndx(0, 0, (obj_220049 != null ? obj_220049.length : 0)+0-1)-0];
				F.line = 445;
				a_220070["set"] = obj_220049[chckIndx(1, 0, (obj_220049 != null ? obj_220049.length : 0)+0-1)-0];
				F.line = 450;
				result_220069 = a_220070;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_220069;

		}

	var result_220048 = null;

	var F={procname:"dyo.useState",prev:framePtr,filename:"dyo.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		F.line = 10;
		var obj_220049 = useState(val_220047);
		F.line = 11;
		result_220048 = innerHEX60gensym220066_220067();
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_220048;

}

function use_state_220658(val_220660) {

		function innerHEX60gensym220668_220669() {
			var result_220671 = null;

			var F={procname:"useState.inner`gensym220668",prev:framePtr,filename:"jsffi.nim",line:0};
			framePtr = F;
			BeforeRet: do {
				F.line = 430;
				var a_220672 = null;
				...
				a_220672 = {};
				F.line = 441;
				a_220672.val = obj_220662[chckIndx(0, 0, (obj_220662 != null ? obj_220662.length : 0)+0-1)-0];
				F.line = 445;
				a_220672["set"] = obj_220662[chckIndx(1, 0, (obj_220662 != null ? obj_220662.length : 0)+0-1)-0];
				F.line = 450;
				result_220671 = a_220672;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_220671;

		}

	var result_220661 = null;

	var F={procname:"dyo.useState",prev:framePtr,filename:"dyo.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		F.line = 16;
		var obj_220662 = useState(val_220660);
		F.line = 17;
		result_220661 = innerHEX60gensym220668_220669();
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_220661;
...
function map_222239(s_222244, op_222247) {
	var result_222249 = null;

	var F={procname:"map.map",prev:framePtr,filename:"sequtils.nim",line:0};
	framePtr = F;
		F.line = 311;
		result_222249 = new Array(chckRange((s_222244 != null ? s_222244.length : 0), 0, 2147483647)); for (var i=0;i<chckRange((s_222244 != null ? s_222244.length : 0), 0, 2147483647);++i) {result_222249[i]=null;}		L1: do {
			F.line = 312;
			var i_222272 = 0;
			F.line = 2737;
			var colontmp__223403 = 0;
			F.line = 312;
			colontmp__223403 = (s_222244 != null ? s_222244.length : 0);
			F.line = 2739;
			var i_223404 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_223404 < colontmp__223403)) break L3;
						F.line = 312;
						i_222272 = i_223404;
						F.line = 313;
						result_222249[chckIndx(i_222272, 0, (result_222249 != null ? result_222249.length : 0)+0-1)-0] = op_222247(s_222244[chckIndx(i_222272, 0, (s_222244 != null ? s_222244.length : 0)+0-1)-0]);
						F.line = 2742;
						i_223404 = addInt(i_223404, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;

	return result_222249;

}

function call_222014() {
...
function input_222029(e_222031) {
	var F={procname:"app.input",prev:framePtr,filename:"app.nim",line:0};
	framePtr = F;
		F.line = 8;
		rawEcho(cstrToNimstr(e_222031.target.value));
	framePtr = F.prev;

	
}

function update_count_222047(count_222049) {
	var F={procname:"app.updateCount",prev:framePtr,filename:"app.nim",line:0};
	framePtr = F;
		count_222049.set((addInt((count_222049.val), 1)));
	framePtr = F.prev;

	
}

function map_223300(s_223305, op_223308) {
	var result_223310 = null;

	var F={procname:"map.map",prev:framePtr,filename:"sequtils.nim",line:0};
	framePtr = F;
		F.line = 311;
		result_223310 = new Array(chckRange((s_223305 != null ? s_223305.length : 0), 0, 2147483647)); for (var i=0;i<chckRange((s_223305 != null ? s_223305.length : 0), 0, 2147483647);++i) {result_223310[i]=null;}		L1: do {
			F.line = 312;
			var i_223333 = 0;
			F.line = 2737;
			var colontmp__223409 = 0;
			F.line = 312;
			colontmp__223409 = (s_223305 != null ? s_223305.length : 0);
			F.line = 2739;
			var i_223410 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_223410 < colontmp__223409)) break L3;
						F.line = 312;
						i_223333 = i_223410;
						F.line = 313;
						result_223310[chckIndx(i_223333, 0, (result_223310 != null ? result_223310.length : 0)+0-1)-0] = op_223308(s_223305[chckIndx(i_223333, 0, (s_223305 != null ? s_223305.length : 0)+0-1)-0]);
						F.line = 2742;
						i_223410 = addInt(i_223410, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;

	return result_223310;
...
export default function app() {
		...
		function HEX3Aanonymous_222123(row_222131) {

				function innerHEX60gensym222141_222142() {
					var result_222144 = null;

					var F={procname:":anonymous.inner`gensym222141",prev:framePtr,filename:"jsffi.nim",line:0};
					framePtr = F;
					BeforeRet: do {
						F.line = 430;
						var a_222145 = null;
						...
						a_222145 = {};
						F.line = 443;
						a_222145["style"] = "color:#ff6600";
						F.line = 450;
						result_222144 = a_222145;
						break BeforeRet;
					} while (false);
					framePtr = F.prev;

					return result_222144;

				}

			var result_222135 = null;

			var F={procname:"app.:anonymous",prev:framePtr,filename:"app.nim",line:0};
			framePtr = F;
				F.line = 22;
				result_222135 = h("li", innerHEX60gensym222141_222142(), toJSStr(cstrToNimstr((row_222131)+"")));
			framePtr = F.prev;

			return result_222135;

		}

		function innerHEX60gensym222293_222294() {

				function HEX3Aanonymous_222401() {
					var F={procname:"inner`gensym222293.:anonymous",prev:framePtr,filename:"jsffi.nim",line:0};
					framePtr = F;
						F.line = 24;
						call_222014();
					framePtr = F.prev;
			...
			var result_222296 = null;

			var F={procname:"app.inner`gensym222293",prev:framePtr,filename:"jsffi.nim",line:0};
			framePtr = F;
			BeforeRet: do {
				F.line = 430;
				var a_222297 = null;
				...
				a_222297 = {};
				F.line = 443;
				a_222297["onclick"] = HEX3Aanonymous_222401;
				F.line = 450;
				result_222296 = a_222297;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_222296;

		}

		function innerHEX60gensym222447_222448() {

				function HEX3Aanonymous_222601(e_222603) {
					var F={procname:"inner`gensym222447.:anonymous",prev:framePtr,filename:"jsffi.nim",line:0};
					framePtr = F;
						F.line = 27;
						input_222029(e_222603);
					framePtr = F.prev;

					
				}

			var result_222450 = null;

			var F={procname:"app.inner`gensym222447",prev:framePtr,filename:"jsffi.nim",line:0};
			framePtr = F;
			BeforeRet: do {
				F.line = 430;
				var a_222451 = null;
				...
				a_222451 = {};
				F.line = 443;
				a_222451["oninput"] = HEX3Aanonymous_222601;
				F.line = 443;
				a_222451["placeholder"] = "console.log";
				F.line = 450;
				result_222450 = a_222451;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_222450;

		}

		function innerHEX60gensym222841_222842() {

				function HEX3Aanonymous_223001() {
					var F={procname:"inner`gensym222841.:anonymous",prev:framePtr,filename:"jsffi.nim",line:0};
					framePtr = F;
						F.line = 34;
						update_count_222047(count_222098);
					framePtr = F.prev;

					
				}

			var result_222844 = null;

			var F={procname:"app.inner`gensym222841",prev:framePtr,filename:"jsffi.nim",line:0};
			framePtr = F;
			BeforeRet: do {
				F.line = 430;
				var a_222845 = null;
				...
				a_222845 = {};
				F.line = 443;
				a_222845["onclick"] = HEX3Aanonymous_223001;
				F.line = 450;
				result_222844 = a_222845;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_222844;

		}

		function innerHEX60gensym223063_223064() {

				function HEX3Aanonymous_223201(e_223203) {
					var F={procname:"inner`gensym223063.:anonymous",prev:framePtr,filename:"jsffi.nim",line:0};
					framePtr = F;
						msg_222099.set((e_223203.target.value));
					framePtr = F.prev;

					
				}

			var result_223066 = null;

			var F={procname:"app.inner`gensym223063",prev:framePtr,filename:"jsffi.nim",line:0};
			framePtr = F;
			BeforeRet: do {
				F.line = 430;
				var a_223067 = null;
				...
				a_223067 = {};
				F.line = 443;
				a_223067["oninput"] = HEX3Aanonymous_223201;
				F.line = 450;
				result_223066 = a_223067;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_223066;

		}

		function HEX3Aanonymous_223271(row_223279) {
			var result_223284 = null;

			var F={procname:"app.:anonymous",prev:framePtr,filename:"dyo.nim",line:0};
			framePtr = F;
				F.line = 24;
				result_223284 = row_223279;
			framePtr = F.prev;

			return result_223284;

		}

	var result_222093 = null;

	var F={procname:"app.app",prev:framePtr,filename:"app.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		F.line = 15;
		var list_222097 = [1, 2, 3];
		F.line = 16;
		var count_222098 = use_state_220045(0);
		F.line = 17;
		var msg_222099 = use_state_220658([]);
		F.line = 19;
		result_222093 = h("div", {}, [h("h1", {}, "Nim-dyo"), h("ul", {}, map_222239(list_222097, HEX3Aanonymous_222123)), h("button", innerHEX60gensym222293_222294(), "Hello"), h("div", {}, [h("input", innerHEX60gensym222447_222448(), "")]), h("hr", {}, ""), h("div", {}, [h("h2", {}, "useState"), h("button", innerHEX60gensym222841_222842(), "add"), h("p", {}, toJSStr(cstrToNimstr(((count_222098.val))+""))), h("input", innerHEX60gensym223063_223064(), ""), h("p", {}, map_223300([(msg_222099.val)], HEX3Aanonymous_223271))])]);
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_222093;

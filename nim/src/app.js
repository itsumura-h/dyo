...
function aux_write_stack_trace_21151(f_21153) {
	...
	var result_21154 = [null];
		...
		L6: do {
			var j_21421 = 0;
			var colontmp__220683 = 0;
			colontmp__220683 = (i_21164 - 1);
			var res_220688 = colontmp__220683;
			L7: do {
					L8: while (true) {
					if (!(0 <= res_220688)) break L8;
						j_21421 = res_220688;
...
function map_220239(s_220244, op_220247) {
	var result_220249 = null;

	var F={procname:"map.map",prev:framePtr,filename:"sequtils.nim",line:0};
	framePtr = F;
		F.line = 311;
		result_220249 = new Array(chckRange((s_220244 != null ? s_220244.length : 0), 0, 2147483647)); for (var i=0;i<chckRange((s_220244 != null ? s_220244.length : 0), 0, 2147483647);++i) {result_220249[i]=null;}		L1: do {
			F.line = 312;
			var i_220272 = 0;
			F.line = 2737;
			var colontmp__220676 = 0;
			F.line = 312;
			colontmp__220676 = (s_220244 != null ? s_220244.length : 0);
			F.line = 2739;
			var i_220677 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_220677 < colontmp__220676)) break L3;
						F.line = 312;
						i_220272 = i_220677;
						F.line = 313;
						result_220249[chckIndx(i_220272, 0, (result_220249 != null ? result_220249.length : 0)+0-1)-0] = op_220247(s_220244[chckIndx(i_220272, 0, (s_220244 != null ? s_220244.length : 0)+0-1)-0]);
						F.line = 2742;
						i_220677 = addInt(i_220677, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;

	return result_220249;

}

function call_220029() {
...
function input_220044(e_220046) {
		var Tmp1;

	var F={procname:"app.input",prev:framePtr,filename:"app.nim",line:0};
	framePtr = F;
		F.line = 10;
		rawEcho(cstrToNimstr(e_220046.target.value));
		F.line = 11;
		count_220015[0] = ((Tmp1 = e_220046.target.value, Tmp1) != null ? Tmp1.length : 0);
	framePtr = F.prev;
...
export default function app() {
		...
		function HEX3Aanonymous_220097(row_220105) {

				function innerHEX60gensym220121_220122() {
					var result_220124 = null;

					var F={procname:":anonymous.inner`gensym220121",prev:framePtr,filename:"jsffi.nim",line:0};
					framePtr = F;
					BeforeRet: do {
						F.line = 430;
						var a_220125 = null;
						...
						a_220125 = {};
						F.line = 443;
						a_220125["style"] = "color:#ff6600";
						F.line = 450;
						result_220124 = a_220125;
						break BeforeRet;
					} while (false);
					framePtr = F.prev;

					return result_220124;

				}

			var result_220109 = null;

			var F={procname:"app.:anonymous",prev:framePtr,filename:"app.nim",line:0};
			framePtr = F;
				F.line = 19;
				result_220109 = h("li", innerHEX60gensym220121_220122(), toJSStr(cstrToNimstr((row_220105)+"")));
			framePtr = F.prev;

			return result_220109;

		}

		function innerHEX60gensym220293_220294() {

				function HEX3Aanonymous_220401() {
					var F={procname:"inner`gensym220293.:anonymous",prev:framePtr,filename:"jsffi.nim",line:0};
					framePtr = F;
						F.line = 21;
						call_220029();
					framePtr = F.prev;
			...
			var result_220296 = null;

			var F={procname:"app.inner`gensym220293",prev:framePtr,filename:"jsffi.nim",line:0};
			framePtr = F;
			BeforeRet: do {
				F.line = 430;
				var a_220297 = null;
				...
				a_220297 = {};
				F.line = 443;
				a_220297["onclick"] = HEX3Aanonymous_220401;
				F.line = 450;
				result_220296 = a_220297;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_220296;

		}

		function innerHEX60gensym220447_220448() {

				function HEX3Aanonymous_220601(e_220603) {
					var F={procname:"inner`gensym220447.:anonymous",prev:framePtr,filename:"jsffi.nim",line:0};
					framePtr = F;
						F.line = 23;
						input_220044(e_220603);
					framePtr = F.prev;

					
				}

			var result_220450 = null;

			var F={procname:"app.inner`gensym220447",prev:framePtr,filename:"jsffi.nim",line:0};
			framePtr = F;
			BeforeRet: do {
				F.line = 430;
				var a_220451 = null;
				...
				a_220451 = {};
				F.line = 443;
				a_220451["oninput"] = HEX3Aanonymous_220601;
				F.line = 450;
				result_220450 = a_220451;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_220450;

		}

	var result_220064 = null;

	var F={procname:"app.app",prev:framePtr,filename:"app.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		F.line = 15;
		var list_220068 = [1, 2, 3];
		F.line = 16;
		result_220064 = h("div", {}, [h("h1", {}, "Nim-dyo"), h("ul", {}, map_220239(list_220068, HEX3Aanonymous_220097)), h("button", innerHEX60gensym220293_220294(), "button"), h("div", {}, [h("input", innerHEX60gensym220447_220448(), "")]), h("p", {}, toJSStr(cstrToNimstr((count_220015[0])+"")))]);
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_220064;

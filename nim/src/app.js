...
function aux_write_stack_trace_21151(f_21153) {
	...
	var result_21154 = [null];
		...
		L6: do {
			var j_21421 = 0;
			var colontmp__218478 = 0;
			colontmp__218478 = (i_21164 - 1);
			var res_218483 = colontmp__218478;
			L7: do {
					L8: while (true) {
					if (!(0 <= res_218483)) break L8;
						j_21421 = res_218483;
...
function map_218239(s_218244, op_218247) {
	var result_218249 = null;

	var F={procname:"map.map",prev:framePtr,filename:"sequtils.nim",line:0};
	framePtr = F;
		F.line = 311;
		result_218249 = new Array(chckRange((s_218244 != null ? s_218244.length : 0), 0, 2147483647)); for (var i=0;i<chckRange((s_218244 != null ? s_218244.length : 0), 0, 2147483647);++i) {result_218249[i]=null;}		L1: do {
			F.line = 312;
			var i_218272 = 0;
			F.line = 2737;
			var colontmp__218471 = 0;
			F.line = 312;
			colontmp__218471 = (s_218244 != null ? s_218244.length : 0);
			F.line = 2739;
			var i_218472 = 0;
			L2: do {
				F.line = 2740;
					L3: while (true) {
					if (!(i_218472 < colontmp__218471)) break L3;
						F.line = 312;
						i_218272 = i_218472;
						F.line = 313;
						result_218249[chckIndx(i_218272, 0, (result_218249 != null ? result_218249.length : 0)+0-1)-0] = op_218247(s_218244[chckIndx(i_218272, 0, (s_218244 != null ? s_218244.length : 0)+0-1)-0]);
						F.line = 2742;
						i_218472 = addInt(i_218472, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;

	return result_218249;

}

function call_218029() {
	var F={procname:"app.call",prev:framePtr,filename:"app.nim",line:0};
	framePtr = F;
		F.line = 7;
		rawEcho(makeNimstrLit("aaa"));
	framePtr = F.prev;
...
export default function app() {
		...
		function HEX3Aanonymous_218081(row_218089) {

				function innerHEX60gensym218105_218106() {
					var result_218108 = null;

					var F={procname:":anonymous.inner`gensym218105",prev:framePtr,filename:"jsffi.nim",line:0};
					framePtr = F;
					BeforeRet: do {
						F.line = 430;
						var a_218109 = null;
						...
						a_218109 = {};
						F.line = 443;
						a_218109["style"] = "color:#ff6600";
						F.line = 450;
						result_218108 = a_218109;
						break BeforeRet;
					} while (false);
					framePtr = F.prev;

					return result_218108;

				}

			var result_218093 = null;

			var F={procname:"app.:anonymous",prev:framePtr,filename:"app.nim",line:0};
			framePtr = F;
				F.line = 14;
				result_218093 = h("li", innerHEX60gensym218105_218106(), toJSStr(cstrToNimstr((row_218089)+"")));
			framePtr = F.prev;

			return result_218093;

		}

		function innerHEX60gensym218293_218294() {
			var result_218296 = null;

			var F={procname:"app.inner`gensym218293",prev:framePtr,filename:"jsffi.nim",line:0};
			framePtr = F;
			BeforeRet: do {
				F.line = 430;
				var a_218297 = null;
				...
				F.line = 443;
				F.line = 439;
				a_218297["onclick"] = call_218029();
				F.line = 450;
				result_218296 = a_218297;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_218296;

		}

	var result_218048 = null;

	var F={procname:"app.app",prev:framePtr,filename:"app.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		F.line = 10;
		var list_218052 = [1, 2, 3];
		F.line = 11;
		result_218048 = h("div", {}, [h("h1", {}, "Hello"), h("ul", {}, map_218239(list_218052, HEX3Aanonymous_218081)), h("button", innerHEX60gensym218293_218294(), "button"), h("p", {}, toJSStr(cstrToNimstr((count_218015[0])+"")))]);
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_218048;
